...
נעלי ריצה הן כלי טכנולוגי שנועד לגשר בין כף הרגל האנושית לבין משטחי ריצה קשיחים. השפעתן על האנטומיה והפיזיולוגיה של הרץ היא נושא נרחב במחקר הקינזיולוגי. הנעל היא רק מרכיב אחד בציוד: שכבת הבסיס נדונה בעמוד [תחתונים לריצה](/run/run_shorts/), וניהול העומס עצמו בעמוד [אזורי דופק בריצה](/run/running-zones/).
...
* **טנדינופתיה של האכילס (Achilles Tendinopathy):** גיד האכילס נדרש לאגור ולשחרר אנרגיה אלסטית בעוצמה גבוהה. ללא הסתגלות מתאימה, העומס האקסצנטרי (בלימה) מוביל לשינויים ניווניים במבנה ה[קולגן](/food/collagen/) של הגיד.
...
4. **הפחתת עומס במקביל:** בתקופת ההסתגלות כדאי להוריד את נפח האימון לרובו ל[אזור 2](/run/running-zones/), שבו כוחות האימפקט נמוכים יותר.
