...
* **פרופיל ויטמינים רחב:** ביצים מספקות ויטמינים מקבוצת B (בעיקר B12 וריבופלאבין), [ויטמין D](/food/supplements/vitamin-d/) (שקשה למצוא במזון מהחי) ו[סלניום](/food/supplements/selenium/) המשמש כנוגד חמצון רב עוצמה.
...
* **ספיגת ביוטין (בביצים נאות):** חלבון הביצה הנא מכיל חלבון בשם **אבידין**, הנקשר לוויטמין ביוטין (B7) ומונע את ספיגתו. בישול הביצה מנטרל את האבידין ומאפשר את ספיגת הוויטמין.
