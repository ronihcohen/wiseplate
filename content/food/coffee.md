...
פולי קפה מכילים מאות תרכובות — [קפאין](/food/supplements/caffeine/), חומצות כלורוגניות, דיטרפנים (קאפסטול וקהוול), טריגונלין ועוד — שפועלות יחד ליצירת הפרופיל הביואקטיבי המורכב.

### יתרונות בריאותיים מבוססי מחקר

* **מקור מוביל לנוגדי חמצון בתפריט המערבי:** מחקרים תזונתיים בארה"ב ובאירופה מצאו שקפה (לא פירות או ירקות) הוא מקור נוגדי החמצון הגדול ביותר בתפריט הממוצע — בשל הכמות הגבוהה הנצרכת. חומצות כלורוגניות הן ה[פוליפנולים](/food/polyphenols/) העיקריים, עם פעילות אנטי-דלקתית וויסות גלוקוז.
...
* **ספיגת ברזל:** קפה (כמו תה) מפחית ספיגת [ברזל](/food/iron/) לא-המי. לא לשתות סמוך לארוחות עשירות בברזל.
...
תשובה: מבחינה תזונתית — כן. תוספת סוכר ו[חלב](/food/milk/) שמן מוסיפה קלוריות ומפחיתה חלק מהאפקטים הביואקטיביים. קפה שחור אופטימלי.
...
תשובה: צריכה קיצונית מוגזמת מקושרת קלות לירידה בצפיפות עצם. בכמות מתונה (3-4 כוסות) עם תזונה עשירה ב[סידן](/food/supplements/calcium/) — הסיכון זניח.
